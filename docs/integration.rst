...
``composefs``
  ...
  To mount an installed composefs artifact, can use a command like this:

  .. code-block:: shell

     mount -t composefs -o basedir=$CFS_REPO/.rauc-cfs-store $CFS_REPO/my-app/image /run/mnt/my-app
